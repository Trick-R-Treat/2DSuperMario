...
public class PlayerMovement : MonoBehaviour
{
    ...
    private new Rigidbody2D rigidbody;  //Mahdollistaa k‰ytt‰ytymisen fysiikan lakien mukaan.
    private new Collider2D collider;

    private Vector2 velocity;
    private float inputAxis;

    public float moveSpeed = 8f; //Luodaan Inspectoriin laatikko nopeudelle, jonka avulla pystyy s‰‰t‰m‰‰n helposti pelaajan liikkumisnopeutta.
    ...
    private void FixedUpdate()
    {
        ...
        //M‰‰ritet‰‰n, ett‰ pelaaja pysyy mini- ja maksimiarvojen sis‰ll‰. Koska pelaajan keskipiste on sen keskell‰, niin luvuilla +0.5 ja -0.5 m‰‰ritet‰‰n,
        //ett‰ pelaaja n‰kyy kokonaan ruudussa, eik‰ katoa puoliksi sen ulkopuolelle.
    ...
    private void HorizontalMovement()  //Pelaajan vaakasuoraan liikkuminen.
    {
        ...
        velocity.x = Mathf.MoveTowards(velocity.x, inputAxis * moveSpeed, moveSpeed * Time.deltaTime);  //T‰ss‰ asetetaan pelaajan nopeus siten, ett‰ kiihtyvyys ja hidastuvuus on n‰ht‰viss‰.

        //Jos pelaaja tˆrm‰‰ esim. putkeen, vauhti pys‰htyy. Ilman t‰t‰ pelaaja n‰ytt‰isi hetkellisesti liimautuvan objektiin kiinni ja vasta sitten se kykenisi vaihtamaan suuntaa.
