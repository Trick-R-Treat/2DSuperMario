...
public class PlayerSpriteRenderer : MonoBehaviour
{
    ...
    //N‰m‰ ilmestyy hahmon Inspectoriin, jolloin hahmon animaatiot voi raahata Sprites -kansiosta oikeisiin kohtiin.
    public Sprite idle;
    public Sprite jump;
    public Sprite slide;
    ...
    private void LateUpdate()  //P‰ivitet‰‰n hahmon ulkon‰kˆ vasta sen j‰lkeen kun kaikki erilaiset fysiikka- ja liiketilat on p‰ivitetty.
    {
        ...
        {
            spriteRenderer.sprite = slide;  //...k‰ytet‰‰n slide-animaatiota.
        }
